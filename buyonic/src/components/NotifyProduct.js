...
export const NotifyProduct = ({ product }) => {
  ...
  const [price, setPrice] = useState(product.below)
              ...
              <CardContent>
                <div className='px-4'>
                  ...
                  <h1 className='text-4xl font-bold text-green-400'>
                    Price: ₹ {product.product.cost && product.product.cost}
                  </h1>
                  <h1 className='text-4xl font-bold text-green-400'>
                    Watch for: ₹ {product.below && product.below}
                  </h1>
                </div>
              </CardContent>
            </Link>
          ...
          <CardActions disableSpacing>
            <div className='flex justify-between items-center pb-4'>
              <div className='inline-flex items-center rounded-xl shadow-lg shadow-green-400/20 hover:shadow-green-400/40 bg-green-400 px-3 py-2 text-gray-800 ml-6' onClick={() => setShowModal1(true)} >
                <EditIcon />
                <h1 className='font-semibold text-lg'>Edit Watch</h1>
              </div>
              <div className='inline-flex items-center rounded-xl shadow-lg hover:shadow-green-400/20 bg-gray-800 px-3 py-2 text-green-400 ml-2' onClick={() => setShowModal2(true)} >
                <DeleteIcon />
                <h1 className='font-semibold text-lg'>Delete Watch</h1>
              </div>
            </div>
          </CardActions>
        </Card> :
